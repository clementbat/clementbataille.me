<template>
  <section class="projects">
    ...
    <p>
      I built a treemap in JavaScript from scratch based on
      <a href="https://www.win.tue.nl/~vanwijk/stm.pdf" target="_blank">this algorithm</a>.
    </p>
    <div class="projectLinks">
      ...
      <a
        href="https://medium.com/foxintelligence-inside/building-a-treemap-with-javascript-4d789ad43a85"
        target="_blank"
      >
        <img src="../assets/icons/description.svg" alt="blog icon" />How it works (blog post)
      </a>
      <a
        href="https://github.com/clementbat/projects/blob/master/treemap/index.html"
        target="_blank"
      >
        <img src="../assets/icons/code.svg" />Code
      </a>
    </div>
    ...
    >
      <div
        @click="treemapOverlay = false"
        class="treemapDemo__overlay"
        :style="{
    ...
    <p>
      ...
      <a
        href="https://www.civiweb.com/FR/offre-liste.aspx"
        target="_blank"
      >Civiweb</a>.
    ...
    <p>A small interface to extract your friend's birthday dates</p>
    <div class="projectLinks">
      <a href="#fbBdayDemo" class="liveDemo">
        <img src="../assets/icons/play_circle.svg" alt="play icon" />Live demo
      </a>
      <a
        href="https://github.com/clementbat/projects/blob/master/fb-birthday-extract/index.html"
        target="_blank"
      >
        <img src="../assets/icons/code.svg" />Code
      </a>
    ...
    <div id="fbBdayDemo" class="fbBdayDemo">
      <div
        @click="fbExtractOverlay = false"
        class="fbBdayDemo__overlay"
        :style="{
...
.treemapDemo {
  ...
  box-shadow: rgba(0, 0, 0, 0.7) 10px 15px 40px 20px;
  position: relative;
  border-radius: 4px;
  max-width: 90vw;
  min-height: 70vh;
...
.treemapDemo__overlay > button,
.fbBdayDemo__overlay > button {
  position: relative;
  top: calc(50% - 25px);
  font-size: 24px;
  font-weight: 600;
